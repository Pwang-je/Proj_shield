		...
		<section>
			...
			<div class="wrap col-md-12" style="padding:0;">
				...
				<div class="header">
					...
					<div class="navbar col-xs-2 col-md-2" style="background-color: #35435a;">
						...
						<div class="search-form col-md-12">
							...
							<form action="herolist_a.jsp" name="frm" method="post" class="col-md-12">
							<div class="col-md-12">
				...
				<div class="contents col-md-10">
					...
					<div id="center" class="swiper-container col-xs-12 col-md-12">
					
					<div class="swiper-wrapper">
	<%
 
    ArrayList<HeroBean> list  = heroMgr.getHeroesAll(stype, sword);
	for(HeroBean h:list) {
		if(h.getApproval() == 1) {	
	%>	
						<div class="swiper-slide card-common col-xs-3 col-md-3">
							...
							<div class="prof-options col-xs-12 col-md-12">
								<div class="prof-opt-left col-xs-6 col-md-6">
									...
									<a href="heroupdate_a.jsp?name=<%=h.getName()%>">Edit</a>
								</div>
								<div class="prof-opt-right col-xs-6 col-md-6">
									<i class="fa fa-user-o fa-1x" aria-hidden="true"></i> <a
										href="herodetail_a.jsp?name=<%=h.getName()%>">Profile</a>
								</div>
							</div>
						</div>					
	<%
